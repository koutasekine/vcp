// vcp/bfem/constants/dict/ondemand_3d.hpp
//
// CONST-B2b: 3D ondemand ledger (dictionary layer separation, ruling R21).
...
//
// Entry semantics are IDENTICAL to dict/registry_3d.hpp: exact canonical
...
#ifndef VCP_BFEM_CONSTANTS_DICT_ONDEMAND_3D_HPP
#define VCP_BFEM_CONSTANTS_DICT_ONDEMAND_3D_HPP
...
l2_projection_ondemand_3d_entries(int& count) {
    static const l2_projection_registry_entry_3d entries[] = {
        ...
        { { 0LL, 0LL, 0LL, 0LL, 0LL, 0LL },
          { 1LL, 1LL, 1LL, 1LL, 1LL, 1LL }, -1, "sentinel" }
    };
...
inline const l2_projection_registry_entry_3d*
l2_projection_ondemand_3d_table(int& count) {
    return detail::l2_projection_ondemand_3d_entries(count);
}
...
#endif // VCP_BFEM_CONSTANTS_DICT_ONDEMAND_3D_HPP
